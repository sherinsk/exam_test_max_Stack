...
<div className="border border-gray-200 rounded-lg shadow  m-2">
        <img className="rounded-t-lg h-96 w-full object-cover" src={product.thumbnail} alt="product image" />
    ...
    <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-between">
            <h5 className="text-xl tracking-tight text-gray-900 ">{product.title}</h5>
